    ...
    <div id="contentWrapper">
        <div class="page-title title-1">
                <div class="container">
                        <div class="row">
                                <div class="cell-12">
                                        <h1 class="fx" data-animate="fadeInLeft">Products / <?=$category->title?></h1>
                                        <div class="breadcrumbs main-bg fx" data-animate="fadeInUp">
                                                <span class="bold">You Are In:</span><a href="">Home </a><span class="line-separate">/</span><a>Products </a><span class="line-separate">/</span><span><?=$category->title?></span>
                                        </div>
                                </div>
                        </div>
                </div>
                        ...
                        <div class="widget r-posts-w sale-widget fx" data-animate="fadeInRight">
                            ...
                            <div class="widget-content">
                                <ul>
                                        ...
                                        <li <?=($cate->url == $category->url ? 'class="active"' : '')?>>
                                            <a href="<?=site_url()?>/products/category/<?=$cate->url?>"><?=$cate->title?></a>
